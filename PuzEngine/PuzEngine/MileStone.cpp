...
static GraphicComponent MSTexture(&(App::GetAppInstance()->CAM.GetCamX()),&(App::GetAppInstance()->CAM.GetCamY()));
static GraphicComponent BackButton(&(App::GetAppInstance()->CAM.GetCamX()),&(App::GetAppInstance()->CAM.GetCamY()));
static GraphicComponent Dog3(&(App::GetAppInstance()->CAM.GetCamX()),&(App::GetAppInstance()->CAM.GetCamY()));
...
*/
/******************************************************************************/
bool MouseCollisionInMS(Vector ButtonPosi)
{
...
void MileStone::Init()
{
	...
	DEBUG_CLEAR();
	DEBUG_PRINT("This is MileStone State");

	MSTexture.LoadFromFile("milestones.png");
	BackButton.LoadFromFile("ArrowBack.png");
	Dog3.LoadFromFile("charDog3.png");
...
*/
/******************************************************************************/
void MileStone::Update(float dt)
{
	...
	MSTexture.Render(450,350);
	Dog3.Render(1050,400);
